#!/system/bin/sh
# MountZero v4 - Metamodule Install Hook
...
KSU_METAMODULE=mountzero_v4_vfs
...
hot_mount_module() {
    ...
    echo "mountzero_v4: hot-mounting module: $modid" > /dev/kmsg 2>/dev/null
    ...
    if [ $mounted -gt 0 ]; then
        echo "mountzero_v4: hot-mounted $mounted partitions for: $modid" > /dev/kmsg 2>/dev/null
    fi
}
