#!/system/bin/sh
# MountZero v4 - Post-FS-Data Script
...
CONFIG_FILE="/data/adb/mountzero_v4/config.toml"
...
echo 1 > /data/adb/mountzero_v4/.bootcount 2>/dev/null

# Enable MountZero v4 (safety net if metamount.sh didn't)
